...
router.get('/home', async (req, res) => {
    ...
    if (isAdmin !== 'true') {
        ...
        try {
            ...
            res.render('homeAdm.ejs', { admin, complaintsList, cssFiles });
...
router.get('/profile', async (req, res) => {
    var cook = req.cookies;
    console.log('cook ' , cook);
    console.log('req.cookies ' , cook.isAdmin);
    var isA = cook.isAdmin;
    if (isA !== 'true') {
        res.redirect('/');
        ...
        try {
          ...
          console.log('admin == > ' , admin );
            ...
            try {
                ...
                // let lPrice = "";
                // let hPrice = "";
                res.render('profileAdm.ejs', { admin, complaintsList, cssFiles });
    ...
    if (isAdmin !== 'true') {
        ...
        try {
            ...
            try {
                ...
                res.render('complaintAdm.ejs', { admin, complaint, cssFiles });
            }
            catch (error) {
                console.log('error', error);
            }
